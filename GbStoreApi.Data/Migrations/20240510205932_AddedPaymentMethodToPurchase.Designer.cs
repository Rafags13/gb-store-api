...
namespace GbStoreApi.Data.Migrations
{
    ...
    [Migration("20240510205932_AddedPaymentMethodToPurchase")]
    partial class AddedPaymentMethodToPurchase
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("GbStoreApi.Domain.Models.User", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            BirthdayDate = new DateTime(2024, 5, 10, 16, 59, 31, 928, DateTimeKind.Local).AddTicks(9397),
                            Cpf = "00000000000",
