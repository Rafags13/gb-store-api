...
namespace GbStoreApi.Data.Migrations
{
    ...
    [Migration("20240506110014_AddNewAdminToServer")]
    partial class AddNewAdminToServer
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("GbStoreApi.Domain.Models.User", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            BirthdayDate = new DateTime(2024, 5, 6, 7, 0, 14, 492, DateTimeKind.Local).AddTicks(4441),
                            Cpf = "00000000000",
