...
namespace GbStoreApi.Data.Migrations
{
    ...
    [Migration("20240709121821_AddCreatedAtAttributeToUser")]
    partial class AddCreatedAtAttributeToUser
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("GbStoreApi.Domain.Models.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Cpf = "00000000000",
                            CreatedAt = new DateTime(2024, 7, 9, 8, 18, 21, 431, DateTimeKind.Local).AddTicks(9331),
