...
namespace GbStoreApi.Data.Migrations
{
    ...
    [Migration("20240525233042_MovedResponsabilityFromAddressToHaveUserToNByNTable")]
    partial class MovedResponsabilityFromAddressToHaveUserToNByNTable
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("GbStoreApi.Domain.Models.User", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            BirthdayDate = new DateTime(2024, 5, 25, 19, 30, 42, 714, DateTimeKind.Local).AddTicks(8378),
                            Cpf = "00000000000",
