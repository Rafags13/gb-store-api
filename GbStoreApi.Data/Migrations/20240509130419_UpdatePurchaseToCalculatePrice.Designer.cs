...
namespace GbStoreApi.Data.Migrations
{
    ...
    [Migration("20240509130419_UpdatePurchaseToCalculatePrice")]
    partial class UpdatePurchaseToCalculatePrice
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("GbStoreApi.Domain.Models.User", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            BirthdayDate = new DateTime(2024, 5, 9, 9, 4, 19, 158, DateTimeKind.Local).AddTicks(5813),
                            Cpf = "00000000000",
